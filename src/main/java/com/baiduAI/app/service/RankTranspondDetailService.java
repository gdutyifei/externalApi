...
@Slf4j
@Service
public class RankTranspondDetailService {

    @Autowired
    private RankTranspondDetailDAO rankTranspondDetailDAO;
    ...
    public void saveRankTranspondDetail(@Param("openid") String openid, @Param("sales_id") Long sales_id) throws Exception {
        // 转发量+1
        redisService.saveLongToRedis(RedisKey.RANDTRANSPONDSTRING + sales_id);
        ...
        rankTranspondDetailDAO.saveRankTranspondDetail(openid, cuser_id, sales_id);
    }
}
