...
CREATE TABLE `wechat_user_to_c` (
    ...
    `unionId` VARCHAR(200) NULL DEFAULT NULL COMMENT '微信unionId' COLLATE 'utf8mb4_unicode_ci',
    `avatarUrl` VARCHAR(300) NULL DEFAULT NULL COMMENT '头像url' COLLATE 'utf8mb4_unicode_ci',
    `nickName` VARCHAR(20) NULL DEFAULT NULL COMMENT '微信昵称' COLLATE 'utf8mb4_unicode_ci',
